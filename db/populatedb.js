...
CREATE TABLE IF NOT EXISTS developerinfo (id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY, developer TEXT, UNIQUE (developer));
`;

const GenreTable = `
CREATE TABLE IF NOT EXISTS genreinfo (id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY, genre TEXT, UNIQUE (genre));
`;
